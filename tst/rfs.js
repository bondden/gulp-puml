...
suite("gulp-puml on real file system suite",function(){
  ...
  test("test Dot",(done)=>{
    ...
    exec("java -jar "+path.resolve(__dirname+"/../node_modules/esf-puml/bin/plantuml.8033.jar")+" -testdot",(e,r)=>{
      if(e){
        done(e);
        return e;
      }
